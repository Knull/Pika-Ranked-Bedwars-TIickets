import { SlashCommandBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, EmbedBuilder, GuildMemberRoleManager, } from 'discord.js';
...
const data = new SlashCommandBuilder()
    ...
    .setRequired(true)
    .addChoices({ name: 'thread based', value: 'thread' }, { name: 'channel based', value: 'channel' }));
 ...
 */
export async function handleTicketToggleButton(interaction) {
 ...
 */
export async function handleTicketToggleConfirm(interaction) {
    if (!interaction.member || !('roles' in interaction.member)) {
 ...
 */
export async function handleTicketToggleCancel(interaction) {
